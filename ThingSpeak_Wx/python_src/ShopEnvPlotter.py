...
for numdays in dayperiod:
    ...
    ax1.fill_between(dfsub.index.values,dfsub['RH_Percent']-station_accuracy[stations[0]]['RH'],
                     dfsub['RH_Percent']+station_accuracy[stations[0]]['RH'],
                     color='grey',alpha=.25)
    ax1.set_ylabel('RH (%)')
    ax2.plot(dfsub.index.values,dfsub['Barotemperature'],'r')
    ax2.fill_between(dfsub.index.values,dfsub['Barotemperature']-station_accuracy[stations[0]]['Temp'],
                     dfsub['Barotemperature']+station_accuracy[stations[0]]['Temp'],
                     color='grey',alpha=.25)
    ax2.set_ylabel('Temperature (degC)')
    ax3.plot(dfsub.index.values,dfsub['SLP'],'k')
    ax3.fill_between(dfsub.index.values,dfsub['SLP']-station_accuracy[stations[0]]['Baro'],
                     dfsub['SLP']+station_accuracy[stations[0]]['Baro'],
                     color='grey',alpha=.25)
